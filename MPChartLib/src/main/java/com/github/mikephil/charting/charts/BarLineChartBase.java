...
//        tex.setStyle(Style.FILL);
//        canvas.drawRect(0,0,getWidth(),Utils.convertDpToPixel(80f),tex);
        ...
        mXAxisRenderer.setRelHeight(height);//新增控件高度
        mAxisRendererLeft.setRelHeight(height);
        mAxisRendererRight.setRelHeight(height);
    ...
    public void calculateOffsets() {
        ...
        if (!mCustomViewPortEnabled) {
            ...
            float offsetLeft = 0f, offsetRight = 0f, offsetTop = Utils.convertDpToPixel(80f), offsetBottom = 25f;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int size = (int) Utils.convertDpToPixel(80f);
        super.onMeasure(widthMeasureSpec, size + heightMeasureSpec);
    }
