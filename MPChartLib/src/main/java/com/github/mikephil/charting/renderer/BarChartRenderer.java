    ...
    protected void drawDataSet(Canvas c, IBarDataSet dataSet, int index) {
        ...
        if (mChart.isDrawBarShadowEnabled()) {
            ...
            for (int i = 0, count = Math.min((int) (Math.ceil((float) (dataSet.getEntryCount()) * phaseX)), dataSet.getEntryCount());
                ...
                mBarShadowRectBuffer2.top = mBarShadowRectBuffer.top + mViewPortHandler.contentHeight() / 2;
                mBarShadowRectBuffer2.bottom = mBarShadowRectBuffer.bottom;
                mBarShadowRectBuffer2.left = mBarShadowRectBuffer.left;
                mBarShadowRectBuffer2.right = mBarShadowRectBuffer.right;

//                c.drawRect(mBarShadowRectBuffer, mShadowPaint);

                c.drawRoundRect(mBarShadowRectBuffer, 4, 4, mShadowPaint);
...
//                    buffer.buffer[j + 3], mRenderPaint);
            ...
            c.drawRect(buffer.buffer[j], buffer.buffer[j + 1] + height / 2, buffer.buffer[j + 2],
                    buffer.buffer[j + 3], mRenderPaint);
            if (drawBorder) {
//                c.drawRect(buffer.buffer[j], buffer.buffer[j + 1], buffer.buffer[j + 2],
//                        buffer.buffer[j + 3], mBarBorderPaint);
                c.drawRoundRect(buffer.buffer[j], buffer.buffer[j + 1], buffer.buffer[j + 2],
                        buffer.buffer[j + 3], 4, 4, mBarBorderPaint);
